...
def send_pdf_report(request):
    if request.method == 'POST':
        try:
            ...
            context = {
                'selected_button': filters.get('button'),
                'start_date': filters.get('start_date'),
                'end_date': filters.get('end_date'),
                'graphs': filters.get('graphs'),  # List of graph URLs
            }
            ...
            email_subject = 'Dashboard Report'
            email_body = 'Please find the attached report based on your selected filters.'
            email_message = EmailMessage(email_subject, email_body, to=[email])
            email_message.attach('Dashboard_Report.pdf', pdf, 'application/pdf')
            email_message.send()
